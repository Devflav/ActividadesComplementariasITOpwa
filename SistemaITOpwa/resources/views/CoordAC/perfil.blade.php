    ...
    <div class="card-body">
		...
		@endforeach
            <div class="container">
                <div class="form-group">
                    <div class="col-sm">
						<a href="{{ url('CoordAC/editpasswd') }}" class="btn btn-outline-primary"> 
							Cambiar contraseña 
						</a>
					</div>
					<br>
                    <div class="col-sm">
						<a href="{{ url('CoordAC/editperfil') }}" class="btn btn-outline-primary"> 
							Editar 
						</a>
                    </div>
                    <br>
                    <div class="col-sm">
                        <a href="{{ url('CoordAC') }}" class="btn btn-outline-danger"> 
                            Regresar 
                        </a> 
                    </div>
                </div>
