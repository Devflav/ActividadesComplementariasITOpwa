				...
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					<div class="card-body">
						...
						@endforeach
							...
							<center> 
							<a href="{{ url('CoordAC/editpasswd') }}" class="btn btn-outline-primary"> Cambiar contraseña </a>
							<a href="{{ url('CoordAC/editperfil') }}" class="btn btn-outline-primary"> Editar </a>
                            <a href="{{ url('CoordAC') }}" class="btn btn-outline-danger"> Regresar </a> </center>
					</div>
				</div>
			</div>
		</div>
