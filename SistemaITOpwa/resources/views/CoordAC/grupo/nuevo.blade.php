					...
					<div class="card-body">
						...
						<form method="POST" action="{{url('/regGrupo')}}" class="needs-validation">
                            ...
                            <div class="form-group col">
									...
									<input type="text" class="form-control text-uppercase" name="clave" placeholder="Escribe la clave del grupo" pattern="[G]{1}[A-Z]{3}[0-9]{3}|[g]{1}[a-z]{3}[0-9]{3}" required>
								...
								<div class="form-group col">
									...
									<select class="form-control" id="actividades" name="actividad" required> 
										...
										@foreach($actividades as $a)
											<option value="{{ $a->id_actividad }}" require> {{ $a->creditos }}C - {{ $a->clave}} - {{ $a->nombre }} </option>
										@endforeach
									</select>
									<div class="valid-feedback">Valid.</div>
									<div class="invalid-feedback">Por favor rellena el campo.</div>
