				...
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					@endforeach
                            ...
                            <div class="form-group col">
									...
									<input type="text" class="form-control text-uppercase" name="clave" value="{{ $g->clave }}" required>
							...
							<center>
                                ...
                                <a href="{{ url('/CoordAC/grupos/1') }}" class="btn btn-outline-danger"> Cancelar </a> 
                            </center>
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										<div class="modal-header" style="background-color: #1B396A;">
											<h5 class="modal-title text-white" id="staticBackdropLabel"><strong>EDITAR GRUPO</strong></h5>
											<button class="close text-white" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>  </button>
										</div>
										<div class="modal-body">
											<center>INTENTAS EDITAR UN(A) GRUPO <br> ¿ESTÁS SEGURO DE ESTA ACCIÓN?</center><br>
