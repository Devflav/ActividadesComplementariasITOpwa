			...
			<div class="col-md-9">
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					@foreach($persona as $p)
						@if($p->id_puesto == 9)
							<form method="POST" action="{{ url('/habilitar/personal').'/'.$p->id_persona}}" class="needs-validation">
						@else
							<form method="POST" action="{{ url('/update/personal').'/'.$p->id_persona}}" class="needs-validation">
						@endif
					@endforeach
							@csrf
                            @foreach($persona as $p)
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										...
										<div class="modal-body">
											<center>INTENTAS EDITAR UN(A) PERSONAL <br> ¿ESTÁS SEGURO DE ESTA ACCIÓN?</center><br>
