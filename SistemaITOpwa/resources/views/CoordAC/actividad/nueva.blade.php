			...
			<div class="col-md-9">
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					<div class="card-body">
						...
						<form method="POST" action="{{url('/regAct')}}" class="needs-validation">
							@csrf
							<div class="row">
								<div class="form-group col">
									<label for="clave">* Clave:</label>
									<input type="text" class="form-control text-uppercase" placeholder="Clave de la actividad" pattern="[A-Z]{3}[0-9]{2}|[a-z]{3}[0-9]{2}" name="clave" required>
