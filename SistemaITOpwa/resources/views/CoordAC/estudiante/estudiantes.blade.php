                        ...
                        <td>
                            @if($mod)
                                <a href="{{ url('CoordAC/inscribir').'/'.$e->id_persona.'/'.$e->id_depto }}" 
                                    class="btn btn-outline-primary btn-sm" title="Inscribir">
                                    <i class="fa fa-leanpub"></i>
                                </a>
                            @else
                                <a class="btn btn-outline-primary btn-sm disabled"><i class="fa fa-leanpub"></i></a>
                            @endif
                        </td>
                        <td>
                            <a href="{{ url('CoordAC/editEst').$e->id_persona }}" class="btn btn-outline-primary btn-sm"  
                                title="Editar"><i class="fa fa-lg fa-edit"></i>
                            </a>                            
                        </td>
                    @endif
                </tr>
