...
<div class="container form-content col-sm-9">
    ...
    <div class="card-body">
		...
		<div class="container">
			<div class="form-group">
				<div class="col-sm">
					<a href="{{ url('ProfR/editpasswd') }}" class="btn btn-outline-primary"> 
						Cambiar contraseña 
					</a>
				</div>
				<br>
				<div class="col-sm">
					<a href="{{ url('ProfR/editper') }}" class="btn btn-outline-primary"> 
						Editar 
					</a>
				</div>
				<br>
				<div class="col-sm">
					<a href="{{ url('ProfR') }}" class="btn btn-outline-danger"> 
						Regresar 
					</a>
				</div>
			</div>
