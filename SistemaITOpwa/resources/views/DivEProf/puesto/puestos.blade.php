    ...
    <div class="container" style="background-color: transparent; padding-left: 10px; padding-right: 10px; padding-bottom: 55px;">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <a href="{{ url('DivEProf/nuevoPues') }}" class="btn btn-outline-success btn-sm"><i class="fa fa-fw fa-plus"></i> Agregar </a>
                </div>
            </div>

            <form method="GET" action="{{url('/DivEProf/searchpue')}}">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Buscar puesto por Nombre" name="search">
                    <div class="input-group-append">
