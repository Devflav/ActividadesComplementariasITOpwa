			...
			<div class="col-md-9">
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					@foreach($actividad as $a)						
							<form method="GET" action="{{ url('/DivEProf/update/actividad').'/'.$a->id_actividad }}" class="needs-validation">
						@endforeach
							@csrf
                            @foreach($actividad as $a)
							<div class="row">
							...
							<center> 
                                <!-- <a onclick="editar('{{ url('DivEProf/actualizar/actividad').'/'.$a->id_actividad }}')" class="btn btn-outline-primary"> Guardar </a> -->
								...
								<div class="modal-dialog modal-dialog-centered">
									<div class="modal-content">
										...
										<div class="modal-body">
											<center>INTENTAS EDITAR UN(A) ACTIVIDAD <br> ¿ESTAS SEGURO DE ESTA ACCIÓN?</center><br>
