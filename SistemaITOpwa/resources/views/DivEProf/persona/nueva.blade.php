		...
		<div class="row justify-content-center">
			<div class="col-md-9">
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					<div class="card-header text-white" style="background:#1B396A;"> Registrar Nuevo Personal </div>
					<div class="card-body">
						...
						<form method="POST" action="{{url('/DivEProf/regEmp')}}" class="needs-validation">
                            ...
                            <a href="{{ url('/DivEProf/DivEProf/personal/1') }}" class="btn btn-outline-danger"> Cancelar </a> 
							</center>
						</form>
					</div>
				</div>
