				...
				<div class="card border-bottom-0 border-left-0 border-right-0" style="background-color: transparent;">
					...
					<div class="card-body">
						...
						<form method="POST" action="" class="needs-validation">
							...
							@if($p-> estado == 'Actual')
								<center> 
									<a href="{{ url('DivEProf/periodos/1') }}" class="btn btn-outline-primary"> Regresar </a> 
									<label class="text-primary"> | </label>
									<a href="{{ url('DivEProf/editPeri').'/'.$p->id_periodo }}" class="btn btn-outline-primary"> Editar </a> 
								</center>
							@else
								<center> 
