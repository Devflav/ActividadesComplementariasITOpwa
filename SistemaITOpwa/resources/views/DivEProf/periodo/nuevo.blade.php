...
@if (session('Catch') != null)
    ...
    <div class="card-body">
		<form method="POST" action="{{url('DivEProf/regPeriE')}}" class="needs-validation" enctype="multipart/form-data">
			@csrf
			<div class="form-group">
				<div class="col-sm">
					<em>
			...
			<div class="container">
				<div class="form-group">
					...
					<div class="col-sm">
						<a href="{{ url('DivEProf/periodos/1') }}" class="btn btn-outline-danger"> 
							Cancelar 
						</a> 
					</div>
					<div class="col-sm"></div>
