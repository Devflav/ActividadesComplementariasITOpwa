	...
	<div id="app">
		...
		<nav class="navbar navbar-expand-md shadow-sm" style="background-color: transparent;"> <!-- navbar-dark bg-info shadow-sm" -->
			...
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
				<span class="navbar-toggler-icon-dark"><i class="fa fa-fw fa-lg  fa-bars"></i></span>
			</button>
            ...
            <li class="nav-item">
							<a class="nav-link" href="{{ url('ServEsc') }}"><i class="fa fa-fw fa-fw fa-lg fa-home"></i>Inicio</a>
						</li>
            <li class="nav-item">
							<a class="nav-link" href="{{ url('ServEsc/estudiante') }}"><i class="fa fa-fw fa-search"></i>Estudiante</a>
						</li>
            ...
            @guest
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
								<a class="dropdown-item text-primary" href="{{ url('ServEsc/datosGen') }}"><i class="fa fa-fw fa-lg  fa-cog"></i>Mi perfil</a>
								
								<a class="dropdown-item text-primary" href="{{ url('logoutSE') }}" onclick="event.preventDefault(); $('#logout-form').submit();">
									<strong><i class="fa fa-fw fa-lg  fa-sign-out"></i> Cerrar sesión </strong>
								</a>

								<form id="logout-form" action="{{ url('logoutSE') }}" method="POST" style="display: none;">
									@csrf
								</form>
							</div>
						</li>
		...
		<main class="py-4">
      		<center> <h5> Servicios Escolares </h5> </center>
			  <br>
			@yield('content')
		</main>

		<div id="general-footer" class="container-fluid gen-footer bg-secondary text-white">
			<hr>
