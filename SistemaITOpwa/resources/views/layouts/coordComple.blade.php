...
<head>
	...
	<title> Coord Actividades Complementarias	</title>
...
<body id="bodies" style="background-image: url('/images/ac_ito/escudoNac.png'); background-position: left; background-repeat: no-repeat; background-attachment: fixed; padding-bottom: 10px;">
	<div id="app">
		...
		<nav class="navbar navbar-expand-md shadow-sm" style="background-color: transparent;"> <!-- navbar-dark bg-info shadow-sm" -->
            ...
            <li class="nav-item">
							<a class="nav-link" href="{{ url('CoordAC') }}"><i class="fa fa-fw fa-lg  fa-home"></i>Inicio</a>
						</li>	
            <li class="nav-item dropdown">
							...
							<div class="dropdown-menu border-bottom-0 border-left-0 border-right-0">
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/carreras/0') }}"> Carreras  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/critEvaluacion/0') }}"> Criterios Evaluación  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/departamentos/1') }}"> Departamentos  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/lugares/1') }}"> Lugares P/Act.  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/periodos/1') }}"> Periodos Escolares  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/reportes') }}">Reportes</a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/suspLabores/1') }}"> Suspensión de labores  </a>
							</div>
						</li>
			...
			<li class="nav-item dropdown">
							...
							<a class="dropdown-item text-primary" href="{{ url('CoordAC/actividades/1') }}"> Todas </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/actdeptos') }}"> Departamento </a>
								@foreach($tipos as $t)
									<a class="dropdown-item text-primary" href="{{ url('CoordAC/actip').'/'.$t->id_tipo.'/1' }}"> {{ $t -> nombre}} </a>
								@endforeach
							</div>
						</li>
            <li class="nav-item">
			
							<a class="nav-link" href="{{ url('CoordAC/grupos/1') }}"><i class="fa fa-fw fa-users"></i>Grupos</a>
						</li>
			<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-fw fa-lg  fa-child"></i>Usuarios</a>
							<div class="dropdown-menu border-bottom-0 border-left-0 border-right-0">
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/estudiantes/1') }}"> Estudiantes</a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/grados/1') }}"> Grados Personas  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/personal/1') }}"> Personal  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/puestos/0') }}"> Puestos  </a>
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/restUsuario/1') }}"> Restablecer usuario  </a>
							</div>
						</li>
			<li class="nav-item">
							<a class="nav-link" href="{{ url('CoordAC/inscripciones') }}"><i class="fa fa-fw fa-lg  fa-leanpub"></i>Inscripciones</a>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
								<a class="dropdown-item text-primary" href="{{ url('CoordAC/datosGen') }}"><i class="fa fa-fw fa-lg  fa-cog"></i> Mi perfil  </a>
