...
<body id="bodies" style="background-image: url('/images/ac_ito/escudoNac.png'); background-position: left; background-repeat: no-repeat; background-attachment: fixed; padding-bottom: 10px;">
	<div id="app">
		...
		<nav class="navbar navbar-expand-md justify-content-end shadow-sm" style="background-color: transparent;"> <!-- navbar-dark bg-info shadow-sm" -->
				<!-- <div  class="collapse navbar-collapse" id="navbarSupportedContent"> -->
					<ul class="navbar-nav">						

						<li class="nav-item">
							<a class="nav-link" href="{{ url('IniciarSesion') }}"><i class="fa fa-lg fa-fw fa-user"></i> Iniciar sesión</a>
						</li>
