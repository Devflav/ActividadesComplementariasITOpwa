	...
	<div id="app">
		...
		<nav class="navbar navbar-expand-md shadow-sm" style="background-color: transparent;"> <!-- navbar-dark bg-info shadow-sm" -->
			...
			<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					<ul class="navbar-nav">	
			<li class="nav-item">
							<a class="nav-link" href="{{ url('CoordC') }}"><i class="fa fa-fw fa-fw fa-lg fa-home"></i>Inicio</a>
						</li>
            <li class="nav-item">
							<a class="nav-link" href="{{ url('CoordC/estudiante') }}"><i class="fa fa-fw fa-search"></i>Estudiante</a>
						</li>			
            ...
            @guest
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
								<a class="dropdown-item text-primary" href="{{ url('CoordC/datosGen') }}"><i class="fa fa-fw fa-lg  fa-cog"></i>Mi perfil</a>
								
								<a class="dropdown-item text-primary" href="{{ url('logoutCA') }}" onclick="event.preventDefault(); $('#logout-form').submit();">
								<strong><i class="fa fa-fw fa-lg  fa-sign-out"></i> Cerrar sesión </strong>
								</a>


								<form id="logout-form" action="{{ url('logoutCA') }}" method="POST" style="display: none;">
									@csrf
								</form>
							</div>
						</li>
		...
		<main class="py-4">
      		<center> <h5> Coordinadoras(es) de Carreras </h5> </center>
			  <br>
			@yield('content')
		</main>
