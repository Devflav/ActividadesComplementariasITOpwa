...
@if (session('Catch') != null)
    ...
    <div class="card-body">
		...
		<div class="container">
			<div class="form-group">
				<div class="col-sm">
					<a href="{{ url('CoordC/editpasswd') }}" class="btn btn-outline-primary"> 
						Cambiar contraseña 
					</a>
				</div>
				<br>
				<div class="col-sm">
					<a href="{{ url('CoordC/editper') }}" class="btn btn-outline-primary"> 
						Editar 
					</a>
				</div>
				<br>
				<div class="col-sm">
					<a href="{{ url('CoordC') }}" class="btn btn-outline-danger"> 
						Regresar 
					</a>
				</div>
			</div>
