...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_actividad($search, $pagina, Request $request) { 
        ...
        try{
            ...
            $this->logs("Busqueda de actividad(es).", 
                        $search, 
    ...
    public function f_regAct(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de actividad nueva.", 
                        $actividad->id, 
                        $request->user()->id_persona);
    ...
    public function f_deleteact($id_delete, Request $request){
        ...
        try{
            ...
            $this->logs("Eliminación de actividad (lógica).", 
                $id_act, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_gruposB($search, $pagina, Request $request) {
    ...
    public function f_regGrupo(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de grupo nuevo.", 
                $grupo->id, 
                $request->user()->id_persona);
    ...
    public function f_deletegru($id_delete, Request $request){
        ...
        try{
            ...
            $this->logs("Eliminación de grupo (lógica).", 
                $id_delete, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_estudiantesB($search, $pagina, Request $request) { 
        ...
        try{
            ...
            $this->logs("Busqueda de estudiante(s).", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_regEst(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de estudiante nuevo.", 
                $persona->id, 
                $request->user()->id_persona);
    ...
    public function f_editEst($id_est, Request $request){
        ...
        try{
            ...
            $this->logs("Edición de estudiante.", 
                $id_est, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_carreras($search, Request $request) { 
        ...
        try{
            ...
            if($search == "%0%"){
                ...
                $this->logs("Búsqueda de carrera(s).", 
                    $search, 
                    $request->user()->id_persona);
    ...
    public function f_regCar(Request $request){
        ...
        try{
            ...
            $carrera = Mcarrera::create(['id_depto' => $data['id_depto'], 
                    'nombre' => mb_strtoupper($data['tipo'].$data['nombre']), 
                    'estado' => 1
                ]);

            $this->logs("Registrar nueva carrera.", 
                $carrera->id, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_critEva($search, Request $request) {
        ...
        try{
            ...
            if($search == "%0%"){
                ...
                $this->logs("Búsqueda de criterio de evaluación.", 
                    $search,
                    $request->user()->id_persona);
            }
    ...
    public function f_regCritE(Request $request){
        ...
        try{
            ...
            $criterio = Mcriterios_evaluacion::create([
                    'nombre' => mb_strtoupper($data['nombre']),
                    'descripcion' => mb_strtoupper($data['descripcion']), 
                    'estado' => 1
                ]);

            $this->logs("Registro de criterio de evaluación nuevo.", 
                $criterio->id, 
                $request->user()->id_persona);
    ...
    public function f_editCritE($id_critE, Request $request){
        ...
        try{
            ...
            $this->logs("Edición de criterio de evaluación.", 
                $id_critE, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_departamento($search, $pagina, Request $request){
        ...
        try{
            ...
            $this->logs("Búsqueda de departamento(s).", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_regDepto(Request $request){
        ...
        try{
            ...
            $depto = Mdepartamento::create([
                    'id_persona' => $data['id_persona'], 
                    'nombre' => mb_strtoupper($data['nombre']), 
                    'estado' => 1
                ]);

            $this->logs("Registro de departamento nuevo.", 
                $depto->id, 
                $request->user()->id_persona);
        ...
        try{
            ...
            if($asignado == null){
                ...
                if($newjefe == null){
                    ...
                    $this->logs("Edición de departamento.", 
                        $id_dep, 
                        $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_grado($search, $pagina, Request $request) {
    ...
    public function f_regGrado(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de grado nuevo.", 
                $grado->id, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_periodo($search, $pagina, Request $request) {
        ...
        try{
            ...
            $this->logs("Búsqueda de periodo escolar.", 
                $search, 
                $request->user()->id_persona);
 ...
 */
    public function f_regPeriodo(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de periodo escolar nuevo.", 
                $periodo->id, 
                $request->user()->id_persona);
 ...
 */
    public function f_editPeriodo($id_peri, Request $request){
        ...
        try{
            ...
            $this->logs("Edición de periodo escolar.", 
                $id_peri, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_personalB($search, $pagina, Request $request) {
        ...
        try{
            ...
            $this->logs("Búsuqeda de empleado(s).", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_regEmp(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de empleado nuevo.", 
                $persona->id, 
                $request->user()->id_persona);
    ...
    public function f_regAdmin(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de administrador nuevo.", 
                $persona->id, 
                $request->user()->id_persona);

            $this->logs("Deshabilitación de administrador por cambio de administrador.", 
                $request->user()->id_persona, 
                $request->user()->id_persona);
    ...
    public function f_habilitar($id_emp, Request $request){
        ...
        try{
            ...
            $this->logs("Empleado, acceso a sistema restaurado.", 
                $id_emp, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_puestos($search, Request $request) {
        ...
        try{
            ...
            if($search == "%0%"){
                ...
                $this->logs("Búsqueda de puesto(s).", 
                    $search, 
                    $request->user()->id_persona);
    ...
    public function f_regPuesto(Request $request){
        ...
        try{
            ...
            $puesto = Mpuesto::create([
                'nombre' => mb_strtoupper($data['nombre']),
                'descripcion' => $data['descripcion'], 
                'estado' => 1
            ]);

            $this->logs("Registro de puesto nuevo.", 
                $puesto->id, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_r_usuariosB($search, $pagina, Request $request) { 
        ...
        try{
            ...
            $this->logs("Búsqueda de usuario para restablecimiento de credenciales.", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_restartuser($iduser, Request $request) { 
        ...
        try{
            ...
            $this->logs("Reestablecimiento de credenciales de usuario.", 
                $iduser, 
                $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_s_labor($search, $pagina, Request $request) { 
        ...
        try{
            ...
            $this->logs("Búsqueda de fechas inhabiles.", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_regFecha(Request $request){
        ...
        try{
            ...
            if($data['fecha_fin'] == '' || $data['fecha'] == $data['fecha_fin'])  {
                ...
                $fecha = Mfechas_inhabiles::create([
                    'fecha' => $data['fecha'],
                    'motivo' => mb_strtoupper($data['motivo']), 
                    'estado' => 1]);

                $this->logs("Registro de fecha inhabil.", 
                    $fecha->id, 
                    $request->user()->id_persona);
            ...
            elseif($data['fecha'] > $data['fecha_fin']) {
                ...
                $fnew = $data['fecha']; $end = false; $data = [];
                while($end != true){
                    ...
                    $data .= ['id' => $fecha->id, 'motivo' => mb_strtoupper($data['motivo'])
                        ];
                    ...
                    if($fnew == $data['fecha_fin']){ 
                        ...
                        $this->logs("Registro de fechas inhabiles por bloques.", 
                            $data, 
                            $request->user()->id_persona);
...
/*----------------------------------------------------------------------------------------------------*/
    ...
    public function f_lugar($search, $pagina, Request $request) {
        ...
        try{
            ...
            $this->logs("Búsqueda de lugar(es).", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_regLugar(Request $request){
        ...
        try{
            ...
            $this->logs("Registro de lugar nuevo.", 
                $lugar->id, 
                $request->user()->id_persona);
...
/************************************************************************************************** */
    ...
    public function f_inscripPAB($dpt, $pagina, $search, Request $request){
        ...
        try{
            ...
            $this->logs("Búsqueda de inscripcion(es) por aprobar.", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_inscripAB($dpt, $pagina, $search, Request $request){
        ...
        try{
            ...
            $this->logs("Búsqueda de inscripcion(es) aprobadas.", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_inscripNAB($dpt, $pagina, $search, Request $request){
        ...
        try{
            ...
            $this->logs("Búsqueda de inscripcion(es) no aprobadas.", 
                $search, 
                $request->user()->id_persona);
    ...
    public function f_inscripBJB($dpt, $pagina, $search, Request $request){
        ...
        try{
            ...
            $this->logs("Búsqueda de inscripcion(es) dadas de baja.", 
                $search, 
                $request->user()->id_persona);
 ...
 */
    public function f_aprobar($id_ins, $dpt, Request $request){
        ...
        try{
            ...
            $this->logs("Inscripción aprobada.", 
                $id_ins, 
                $request->user()->id_persona);
...
*/
    public function f_noaprobar($id_ins, $dpt, Request $request){
        ...
        try{
            ...
            $this->logs("Inscripción no aprobada.", 
                $id_ins, 
                $request->user()->id_persona);
 ...
 */
    public function f_bajaInscrip($id_ins, $dpt, Request $request){
        ...
        try{
            ...
            $this->logs("Inscripción dada de baja.", 
                $id_ins, 
                $request->user()->id_persona);
 ...
 */
    ...
    public function f_inscrip_outime(Request $request, $ns){
        ...
        try{
            ...
            for($i = 0; $i < $ns; $i++){
                ...
                $_std = Mestudiante::select('id_estudiante')
                    ->where('num_control', $_std)
                    ->first();
            ...
            if( $cupo->cupo_libre < $ns ){
                ...
                for($i = 0; $i < count($_stds); $i++){
                    ...
                    $this->logs("Registro de inscripción fuera de tiempo.", 
                        $ins->id, 
                        $request->user()->id_persona);
                }
    ...
    public function f_register($student, $group, Request $request){
        ...
        try{
            ...
            if($inscrito >= 0 && $inscrito < 2){
                ...
                $ins = Minscripcion::create(['id_estudiante' => $student,
                    'id_grupo' => $group,
                    'fecha' => date('Y-m-d'),
                    'aprobada' => 1]);
    ...
    public function fpdf_imprimir($id_g, Request $request){
        ...
        try{
            ...
            $this->logs("Impresión de horarios grupales.", 
                $id_g, 
                $request->user()->id_persona);
    ...
    public function re_imprimir_grupo($id_g, Request $request)    {
        ...
        try{
            ...
            $this->logs("Reimpresión de horarios grupales.", 
                $id_g, 
                $request->user()->id_persona);
    ...
    public function f_horario($id_ins, Request $request){
        ...
        try{
            ...
            $this->logs("Impresión de horario por estudiante.", 
                $id_ins, 
                $request->user()->id_persona);
    ...
    public function f_editar(Request $request){
        ...
        try{
            ...
            $this->logs("Edición de perfil de usuario.", 
                $request->user()->id_persona, 
                $request->user()->id_persona);
        ...
        try{
            ...
            if($newpswd == $conpswd){
                ...
                Musers::where('id_persona', $user)
                    ...
                    $this->logs("Edición de contraseña de usuario.", 
                        $request->user()->id_persona, 
                        $request->user()->id_persona);
